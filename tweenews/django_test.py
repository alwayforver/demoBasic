...
def event_running(start_str='20150101', end_str='20150102'):
    ...
    if True:
        ...
        for event in xrange(cluster_num_):
            ...
            news_summary, tweets_summary, tweets, tweets_rele, sentiment =  summarization(sentiCL, event_news_list, event_tweet_list, word_dist, vectorizer, time_mu, time_sigma, 5)


        # print Pw_z.shape, Pp_z.shape, Pz_d.shape, cluster_num_
        ...
        cache_file = File(open('./media/cache' + start_str + '_' + end_str, 'w'))
